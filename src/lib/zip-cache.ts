...
export function makeCacheKey(
  ...
  return `${STARTUP_TOKEN}:${seed}:${playersCount}:${teleportStaffLevel}:${actsKey}:${logic}:${hirelingAura?1:0}${hirelingSkills?1:0}:${dropSource}:${disableChat?1:0}:${horadricCube?1:0}`;
}
